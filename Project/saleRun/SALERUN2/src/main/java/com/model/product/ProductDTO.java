...
public class ProductDTO {
	...
	private String prd_food_sortation; //식료품 구분
	...
	private String prd_logo_img;
	 


	public String getPrd_logo_img() {
		return prd_logo_img;
	}
	...
	public void setPrd_logo_img(String prd_logo_img) {
		this.prd_logo_img = prd_logo_img;
	}
	...
	// 사용자 정의 생성자 - 식료품 구분, 판매처, 품목명, 이미지 링크, 가격, 할인가격, 할인율, 구매 링크
	public ProductDTO(String prd_food_sortation, String prd_slr_sortation, String prd_name, String prd_img_link, int prd_price, int prd_dc_price, String prd_dc_rate, String prd_link ,String prd_logo_img) {
	...
	public String toString() {
		return "ProductDTO [prd_number=" + prd_number + ", prd_food_sortation=" + prd_food_sortation
