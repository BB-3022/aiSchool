        ...
        <form>
            ...
            <a href="BenefitC-SPACE.jsp" class="orange-text">C-SPACE</a>
                ...
                <div class="#" style="margin-left:30px; width: 80%;">
                  ...
                  <img src="img/benefit/CUcard1.png" alt="마트 이미지" style="max-width: 15cm; width: 100%; height: auto;">
                  <br>
                  <img src="img/benefit/CUcard2.png" alt="마트 이미지" style="max-width: 15cm; width: 100%; height: auto;">
                  <br>
                </div>
                </div>
    </div>
