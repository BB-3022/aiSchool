...
/* 네비게이션 바를 앞으로 가져오기 위한 z-index 조정 */
    ...
    /* 슬라이드버튼 수정*/
     .carousel-control-prev, .carousel-control-next {
        background-color: rgba(0, 0, 0, 0.3); /* 연한 배경색 설정 */
        width: 50px;
        height: 50px;
        top: 50%; /* 세로 위치를 중앙으로 조절 */
        transform: translateY(-50%); /* 세로 위치를 중앙으로 조절 */
    }

    .carousel-control-prev-icon, .carousel-control-next-icon {
        background-color: rgba(0, 0, 0, 0.3); /* 버튼 색 설정 */
    }
  ...
  <div id="header-carousel" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active" style="height: 410px;">
            <img class="img-fluid" src="img/slide1.png" alt="Image">
        </div>
        <div class="carousel-item" style="height: 410px;">
            <img class="img-fluid" src="img/slide2.png" alt="Image">
        </div>
        <div class="carousel-item" style="height: 410px;">
            <img class="img-fluid" src="img/slide3.png" alt="Image">
        </div>   
    </div>
        ...
        <div class="col-md-6 " style="margin-light: 30px;">
            <div class="position-relative bg-secondary text-center text-md-right text-white mb-2 py-5 px-5">
                ...
                <div class="position-relative" style="z-index: 1;">
                    <h5 class="text-uppercase mb-3" style="color:#333333;">제휴카드와 멤버십</h5>
                    <h1 class="mb-4 font-weight-semi-bold" style="color:#333333;">할인혜택</h1>
        ...
        <div class="col-md-6">
            <div class="position-relative text-center text-md-left text-white mb-2 py-5 px-5">
                ...
                <div class="position-relative" style="z-index: 1;">
                    ...
                    <h1 class="mb-4 font-weight-semi-bold" style="color:#333333;">할인상품</h1>
