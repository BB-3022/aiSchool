...
<!--                <button id="copyURLBtn" class="btn btn-primary ml-auto">
            ...
            <!-- 현정추가 아래삭제 -->
            <!-- <div id="copySuccess" class="alert alert-success d-none">URL copied successfully!</div> -->
    ...
    <div class="input-group-btn">
        <button class="btn btn-minus" style="background-color: #f7a05e;" onclick="decrementValue()">
            <i class="fa fa-minus" style="color:#333333;"></i>
        </button>
    </div>
    <input type="text" class="form-control bg-secondary text-center" value="1" id="quantityInput">
    <div class="input-group-btn">
        <button class="btn btn-plus" style="background-color: #f7a05e;" onclick="incrementValue()">
            <i class="fa fa-plus" style="color:#333333;"></i>
        </button>
    </div>
</div>
               <form action="Cartaddition" method="post">
                  <input type="hidden" name="crt_number" value="<%=1661%>">
                   <input type="hidden" name="crt_prd_quantity" value="<%=3%>">
                   <input type="hidden" name="crt_prd_number" value="<%="1661"%>">  
                   <input type="hidden" name="crt_id" value="<%=info.getMb_id()%>"> 
                  <button class="btn px-3" style="color:#333333; background-color: #f7a05e;" type="submit" ><i class="fa fa-shopping-cart mr-1"></i>Add Cart</button>
               </form>
               ...
               <form action="Wishprdaddition" method="post">
                  ...
                  <button class="btn border" type="submit"> <i style="color: #f7a05e;" class="fas fa-heart"></i> <span class="badge"></span></button>
               </form>
            </div>
            ...
            <div class="d-flex pt-2">
               <p class="text-dark font-weight-medium mb-0 mr-2" >SNS</p>
               <div class="d-inline-flex">
                  <button id="copyURLBtn" class="btn ml-auto">
                     <i style="color: #f7a05e;"class="fab fa-facebook-f"></i>
                  </button>
                  <button id="copyURLBtn" class="btn ml-auto">
                     <i style="color: #f7a05e;" class="fab fa-twitter"></i>
                  </button>
                  <button id="copyURLBtn" class="btn ml-auto">
                     <i style="color: #f7a05e;" class="fab fa-linkedin-in"></i>
                  </button>                  
                  <button id="copyURLBtn" class="btn  ml-auto">
                     <i style="color: #f7a05e;" class="fab fa-pinterest"></i>
                  </button>
               </div>
            </div>
            <div id="copySuccess" class="alert alert-success d-none">URL copied successfully!</div>
      ...
      <div class="col">
         <div
            ...
            <a class="nav-item nav-link active" data-toggle="tab"
               ...
               data-toggle="tab" href="#tab-pane-2" style="color: #f7a05e;">상세정보</a> <a
               class="nav-item nav-link" data-toggle="tab" href="#tab-pane-3" style="color: #f7a05e;">리뷰(4)</a>
         </div>
            ...
            <div class="owl-carousel related-carousel">
               ...
               <div class="card product-item border-0">
                  <div
                     ...
                     <img class="img-fluid w-100"
                        src="https://sitem.ssgcdn.com/64/81/86/item/1000522868164_i1_1100.jpg"
                        alt="">
                  </div>
                  ...
                  <div
                     ...
                     <h6 class="text-truncate mb-3">태양의 원차 옥수수</h6>
               ...
               <div class="card product-item border-0">
                  <div
                     class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                     <img class="img-fluid w-100"
                        src="https://sitem.ssgcdn.com/22/63/08/item/0000007086322_i1_1100.jpg"
                        alt="">
                  </div>
                  <div
                     class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                     <h6 class="text-truncate mb-3">[남양]몸이 가벼워지는 시간 17차</h6>
                     <div class="d-flex justify-content-center">
                        <h6>874원</h6>
                        <h6 class="text-muted ml-2">
                           <del>950원</del>
               ...
               <div class="card product-item border-0">
                  <div
                     class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                     <img class="img-fluid w-100"
                        src="https://sitem.ssgcdn.com/14/27/90/item/1000050902714_i1_1100.jpg"
                        alt="">
                  </div>
                  <div
                     class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                     <h6 class="text-truncate mb-3">해썹유나인 음료베이스</h6>
                     <div class="d-flex justify-content-center">
                        <h6>9,108원</h6>
                        <h6 class="text-muted ml-2">
                           <del>9,900원</del>
               ...
               <div class="card product-item border-0">
                  <div
                     class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                     <img class="img-fluid w-100"
                        src="https://sitem.ssgcdn.com/33/66/88/item/1000172886633_i1_1100.jpg"
                        alt="">
                  </div>
                  <div
                     class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                     <h6 class="text-truncate mb-3">블랙보리 라이트 1.5L</h6>
                     <div class="d-flex justify-content-center">
                        <h6>1,086원</h6>
                        <h6 class="text-muted ml-2">
                           <del>1,180원</del>
               ...
               <div class="card product-item border-0">
                  <div
                     class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                     <img class="img-fluid w-100"
                        src="https://sitem.ssgcdn.com/74/64/90/item/1000047906474_i1_1100.jpg"
                        alt="">
                  </div>
                  <div
                     class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                     <h6 class="text-truncate mb-3">헛개수 EX 500mL</h6>
                     <div class="d-flex justify-content-center">
                        <h6>2,098원</h6>
                        <h6 class="text-muted ml-2">
                           <del>2,280원</del>
