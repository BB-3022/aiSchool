...
<html>
	...
	<body>
		<%
		// 로그인한 사람의 정보 가져오기
			// 세션을 저장할 때, info가 object 타입으로 업 캐스팅 되어 저장되어있다.
			// 세션은 하나의 메서드로 모든 타입을 저장가능하게 하기 위해 오브젝트 타입이다.
			// info 의 정보를 사용하기 위해서는 MessageDTO 로 다운캐스팅하여 불러와야 한다.
			// info 값의 null 여부로 로그인 성공, 실패 여부 확인이 가능하다.
							...
							<section class="split">
								<section>
									<div class="contact-method">
										...
										<% }else{ %>
											<a href="#">로그인 한 사용자의 이메일을 출력하시오 </a>
										<% }%>
