...
public class ProductDTO {
	...
	public ProductDTO(String prd_food_sortation, String prd_slr_sortation, String prd_name, String prd_img_link, int prd_price, int prd_dc_price, String prd_dc_rate, String prd_link) {
