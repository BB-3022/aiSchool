               ...
               <tbody class="align-middle">
                  <tr>
                   ...
                   <input type="hidden" name="crt_id" value="<%=info.getMb_id()%>">       
                        <button id="delete" class="btn btn-sm btn-primary" type="submit">
            ...
            <div class="card border-secondary mb-5">
               ...
               <div class="card-footer border-secondary bg-transparent">
                  <div class="d-flex justify-content-between mt-2">
                     ...
                     <h6 class="font-weight-bold">할인받은금액</h6>
                     <h6 class="font-weight-bold"><%=GS25_dc_total%>원</h6>
                  </div>
                    <a href="BenefitGS25.jsp" class="btn btn-block btn-primary my-3 py-3">결제혜택 확인</a>
     				<a href="https://gs25.gsretail.com/" class="btn btn-block btn-primary my-3 py-3" target="_blank">온라인 구매하기</a>
      				<a href="map.jsp" class="btn btn-block btn-primary my-3 py-3" onclick="goToOfflineLocation('GS25')">오프라인 판매처</a>
               </div>
            </div>
      <% } else {%>
   <% }%>
            ...
            <div class="card border-secondary mb-5">
               ...
               <div class="card-footer border-secondary bg-transparent">
                  <div class="d-flex justify-content-between mt-2">
                     ...
                     <h6 class="font-weight-bold">할인받은금액</h6>
                     <h6 class="font-weight-bold"><%=CU_dc_total%>원</h6>
                  </div>
                   <a href="BenefitCU25.jsp" class="btn btn-block btn-primary my-3 py-3">결제혜택 확인</a>
     				<a href="https://cu.bgfretail.com/index.do" class="btn btn-block btn-primary my-3 py-3" target="_blank">온라인 구매하기</a>
      				<a href="map.jsp" class="btn btn-block btn-primary my-3 py-3">오프라인 판매처</a>
               </div>
            </div>
      <% } else {%>
   <% }%>
            ...
            <div class="card border-secondary mb-5">
               ...
               <div class="card-footer border-secondary bg-transparent">
                  <div class="d-flex justify-content-between mt-2">
                     ...
                     <h6 class="font-weight-bold">할인받은금액</h6>
                     <h6 class="font-weight-bold"><%=ELEVEn_dc_total%>원</h6>
                  </div>
                     <a href="Benefit7-ELEVEn.jsp" class="btn btn-block btn-primary my-3 py-3">결제혜택 확인</a>
     				<a href="https://www.7-eleven.co.kr/" class="btn btn-block btn-primary my-3 py-3" target="_blank">온라인 구매하기</a>
      				<a href="map.jsp" class="btn btn-block btn-primary my-3 py-3">오프라인 판매처</a>
               </div>
            </div>
      <% } else {%>
            ...
            <div class="card border-secondary mb-5">
               ...
               <div class="card-footer border-secondary bg-transparent">
                  <div class="d-flex justify-content-between mt-2">
                     ...
                     <h6 class="font-weight-bold">할인받은금액</h6>
                     <h6 class="font-weight-bold"><%=emart24_dc_total%>원</h6>
                  </div>
                   <a href="Benefitemart24.jsp" class="btn btn-block btn-primary my-3 py-3">결제혜택 확인</a>
     				<a href="https://www.emart24.co.kr/" class="btn btn-block btn-primary my-3 py-3" target="_blank">온라인 구매하기</a>
      				<a href="map.jsp" class="btn btn-block btn-primary my-3 py-3">오프라인 판매처</a>
               </div>
            </div>
      <% } else {%>
            ...
            <div class="card border-secondary mb-5">
               ...
               <div class="card-footer border-secondary bg-transparent">
                  <div class="d-flex justify-content-between mt-2">
                     ...
                     <h6 class="font-weight-bold">할인받은금액</h6>
                     <h6 class="font-weight-bold"><%=MINISTOP_dc_total%>원</h6>
                  </div>
                    <a href="BenefitMINISTOP.jsp" class="btn btn-block btn-primary my-3 py-3">결제혜택 확인</a>
     				<a href="https://www.ministop.co.kr/" class="btn btn-block btn-primary my-3 py-3" target="_blank">온라인 구매하기</a>
      				<a href="map.jsp" class="btn btn-block btn-primary my-3 py-3">오프라인 판매처</a>
               </div>
            </div>
      <% } else {%>
            ...
            <div class="card border-secondary mb-5">
               ...
               <div class="card-footer border-secondary bg-transparent">
                  <div class="d-flex justify-content-between mt-2">
                     ...
                     <h6 class="font-weight-bold">할인받은금액</h6>
                     <h6 class="font-weight-bold"><%=CSPACE_dc_total%>원</h6>
                  </div>
                    <a href="BenefitC-SPACE.jsp" class="btn btn-block btn-primary my-3 py-3">결제혜택 확인</a>
     				<a href="https://www.cspace.co.kr/main/main.html" class="btn btn-block btn-primary my-3 py-3" target="_blank">온라인 구매하기</a>
      				<a href="map.jsp" class="btn btn-block btn-primary my-3 py-3">오프라인 판매처</a>
               </div>
            </div>
      <% } else {%>
            ...
            <div class="card border-secondary mb-5">
               ...
               <div class="card-footer border-secondary bg-transparent">
                  <div class="d-flex justify-content-between mt-2">
                     ...
                     <h6 class="font-weight-bold">할인받은금액</h6>
                     <h6 class="font-weight-bold"><%=emart_dc_total%>원</h6>
                  </div>
                    <a href="BenefitEmart.jsp" class="btn btn-block btn-primary my-3 py-3">결제혜택 확인</a>
     				<a href="https://store.emart.com/main/main.do" class="btn btn-block btn-primary my-3 py-3" target="_blank">온라인 구매하기</a>
      				<a href="map.jsp" class="btn btn-block btn-primary my-3 py-3">오프라인 판매처</a>
               </div>
            </div>
      <% } else {%>
            ...
            <div class="card border-secondary mb-5">
               ...
               <div class="card-footer border-secondary bg-transparent">
                  <div class="d-flex justify-content-between mt-2">
                     ...
                     <h6 class="font-weight-bold">할인받은금액</h6>
                     <h6 class="font-weight-bold"><%=lotte_dc_total%>원</h6>
                  </div>
                    <a href="BenefitLottemart.jsp" class="btn btn-block btn-primary my-3 py-3">결제혜택 확인</a>
     				<a href="https://www.lotteon.com/p/display/main/lottemart?mall_no=4" class="btn btn-block btn-primary my-3 py-3" target="_blank">온라인 구매하기</a>
      				<a href="map.jsp" class="btn btn-block btn-primary my-3 py-3">오프라인 판매처</a>
               </div>
            </div>
      <% } else {%>
