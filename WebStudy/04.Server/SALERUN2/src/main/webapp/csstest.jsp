 ...
 <!-- mypage START -->
   <div class="container">
      ...
      <form action="EditService" method="post">
         <label for="mb_pw">비밀번호</label> <input type="password" class="form-control mb-3" name="mb_pw" id="mb_pw">
         <label for="mb_pw_confirm">비밀번호 확인</label><input type="password" class="form-control mb-3" name="mb_pw_confirm" id="mb_pw_confirm">
